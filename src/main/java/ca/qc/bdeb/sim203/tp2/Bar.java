   ...
   public void draw(GraphicsContext context) {
      ...
      final double positionImageProjectile = 10 + largeurBarVie;
       ...
       switch (actuel) {
            ...
            case TRIPLE -> context.drawImage(imageHippocampe, PIXELS_AJOUTES + positionImageProjectile, VALEUR_ALIGNEMENT);
            case MAGNET -> context.drawImage(imageSardines, PIXELS_AJOUTES + positionImageProjectile , VALEUR_ALIGNEMENT);
        }
    }
}
